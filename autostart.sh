...
#xrandr --output eDP-1-1 --primary --mode 1920x1080 --output HDMI-1-1 --mode 3840x2160  --left-of eDP-1-1
#xrandr --output eDP-1 --primary --mode 1920x1080 --output HDMI-1 --mode 2560x1440  --left-of eDP-1
...
# Set up Wallpaper
feh --bg-scale ~/Pictures/Wallpapers/trioptimum.jpeg &
sleep 0.5
